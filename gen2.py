...
from PySide6.QtCore import QTimer, QTime, Qt  # Correctly import QTime here
...
class AnalogWatch(QWidget):
    ...
    def paintEvent(self, event):
        ...
        painter.setPen(QPen(Qt.red, 1)) # color of minute hand
        painter.setBrush(Qt.red) # color of minute hand  
